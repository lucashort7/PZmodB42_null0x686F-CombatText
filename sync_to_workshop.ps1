...
$SourcePath = "C:\obsidian\pz-mods-byme\combattext"
$DestPath = "C:\Users\lucas\Zomboid\Workshop\combattext"

Write-Host "Syncing null0x686F CombatText..." -ForegroundColor Cyan
